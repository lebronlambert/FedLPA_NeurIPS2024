        ...
        for round in range(args.comm_round):
            ...
            for name in global_fim.keys():
                ...
                _newtons_param = newton_solve(fed_avg_freqs,
                                              Ak=[f_nets[selected[idx]][name][0]
                                                  for idx in range(len(selected))],
                                              Bk=[f_nets[selected[idx]][name][1]
                                                  for idx in range(len(selected))],
            ...
            logger.info('>> biased Global Model Test accuracy: %f' % best_acc)
            print('>> biased Global Model Test accuracy: %f' % best_acc)
