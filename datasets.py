...
import numpy as np
from torchvision.datasets import MNIST, CIFAR10, SVHN, FashionMNIST, CIFAR100, ImageFolder, DatasetFolder, utils,EMNIST
...
class EMNIST_truncated(data.Dataset):
    ...
    def __build_truncated_dataset__(self):
        ...
        emnist_dataobj = EMNIST(self.root, self.train, self.transform, self.target_transform, self.download,split='mnist')
